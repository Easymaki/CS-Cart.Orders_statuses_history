...
{   
    if (!empty($order)) {
        $order['history'] = db_get_array('SELECT ?:history_orders.user_id, ?:history_orders.status_from, ?:history_orders.status_to, ?:users.firstname, ?:users.lastname FROM ?:history_orders
        LEFT JOIN ?:users
